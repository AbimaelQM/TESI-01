...
class Tela:
    def __init__(self, master):
        ...
        self.tvw.insert('', 'end', values=('Manoel', '0000000000', 'manoel@ufac.br'))
        self.tvw.insert('', 'end', values=('Manoel', '0000000000', 'manoel@ufac.br'))
        self.tvw.insert('', 'end', values=('Manoel', '0000000000', 'manoel@ufac.br'))
        self.tvw.insert('', 'end', values=('Limeira', '1111111111', 'limeira@ufac.br'))
        self.tvw.insert('', 'end', values=('Limeira', '1111111111', 'limeira@ufac.br'))
        self.tvw.insert('', 'end', values=('Limeira', '1111111111', 'limeira@ufac.br'))
        ...
        self.btn_deletar_lista = tk.Button(self.frm_botoes, text='Deletar lista',command=self.deletar_lista)
        self.btn_deletar_lista.pack(side=tk.LEFT)
        self.btn_atualizar = tk.Button(self.frm_botoes, text='Atualizar', command=self.tela_atualizar)
